-- ============================================================================
-- SCRIPT DE CREACIÓN DE TABLAS - PORTAL PROVEEDORES LA CANTERA
-- ============================================================================
-- Base de Datos: PP (SQL Server)
-- Fecha: Diciembre 2024
-- Versión: 1.0
--
-- IMPORTANTE: Este script crea SOLO las tablas nuevas necesarias
-- Reutiliza las tablas existentes: pNetUsuario, pNetUsuarioTipo,
-- pNetUsuarioPassword, Empresa, Prov
-- ============================================================================
...
PRINT '============================================================================';
PRINT 'INICIO - Creación de Tablas del Portal de Proveedores';
PRINT '============================================================================';
GO
...
-- 1.2 Relación Usuario-Empresa (Multi-tenant)
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[pNetUsuarioEmpresa]') AND type in (N'U'))
BEGIN
    PRINT 'Creando tabla: pNetUsuarioEmpresa';
    CREATE TABLE [dbo].[pNetUsuarioEmpresa] (
    ...
    CREATE INDEX IDX_pNetUsuarioEmpresa_Usuario ON pNetUsuarioEmpresa(IDUsuario);
    CREATE INDEX IDX_pNetUsuarioEmpresa_Empresa ON pNetUsuarioEmpresa(Empresa);
    CREATE INDEX IDX_pNetUsuarioEmpresa_Activo ON pNetUsuarioEmpresa(Activo);
    CREATE INDEX IDX_pNetUsuarioEmpresa_Proveedor ON pNetUsuarioEmpresa(ProveedorID);
    PRINT '✓ Tabla pNetUsuarioEmpresa creada';
END
ELSE
    PRINT '⚠ Tabla pNetUsuarioEmpresa ya existe';
GO

-- 1.3 Extensión de Proveedores
...
BEGIN
    ...
    CREATE INDEX IDX_pNetSesiones_Usuario ON pNetSesiones(IDUsuario);
...
BEGIN
    ...
    CREATE INDEX IDX_pNetVerificationTokens_Usuario ON pNetVerificationTokens(IDUsuario);
...
BEGIN
    ...
    CREATE INDEX IDX_pNetPasswordResetTokens_Usuario ON pNetPasswordResetTokens(IDUsuario);
...
BEGIN
    ...
    CREATE INDEX IDX_ProvDocumentos_Usuario ON ProvDocumentos(IDUsuario);
...
BEGIN
    ...
    CREATE TABLE [dbo].[pNetConversaciones] (
        ...
        UltimoMensajeRemitente INT NULL,
...
BEGIN
    ...
    CREATE INDEX IDX_pNetNotificaciones_Usuario_Leida ON pNetNotificaciones(IDUsuario, Leida);
...
BEGIN
    ...
    CREATE INDEX IDX_pNetAuditLog_Usuario_Fecha ON pNetAuditLog(IDUsuario, CreatedAt DESC);
...
PRINT '    - Extensiones: 3';
PRINT '    - Autenticación: 3';
PRINT '    - Catálogos: 3';
PRINT '    - Documentación: 1';
PRINT '    - Mensajería: 2';
PRINT '    - Notificaciones: 1';
PRINT '    - Auditoría: 1';
PRINT '    - Configuración: 1';
PRINT '    - Facturas: 2 (Opcional)';
PRINT '';
