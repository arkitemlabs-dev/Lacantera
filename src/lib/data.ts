...
export const payments: Payment[] = [
    ...
    { id: 'PAY-002', invoiceId: 'FACT-003', supplierName: 'Componentes Electrónicos Globales', amount: 8750.00, executionDate: '18/07/2024', status: 'Realizado en espera de complemento', method: 'Transferencia', paymentProof: true, paymentComplement: false },
