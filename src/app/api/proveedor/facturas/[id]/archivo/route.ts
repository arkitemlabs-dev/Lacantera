// src/app/api/proveedor/facturas/[id]/archivo/route.ts
// Download de archivos de factura (proveedor) — blob-first + fallback filesystem
...
/**
 * GET /api/proveedor/facturas/[id]/archivo?tipo=xml|pdf
...
export async function GET(
  ...
  try {
    ...
    if (storageType === 'blob' && blobPath.startsWith('empresa/')) {
    ...
    console.error('[PROVEEDOR FACTURA ARCHIVO] Error:', error);
    return NextResponse.json(
